...
---
  - **FLARE-VM**  
    A Windows-based virtual machine designed for malware analysis and reverse engineering, packed with analysis and debugging tools.  
    [GitHub - mandiant/flare-vm: A collection of software installations scripts for Windows systems that allows you to easily setup and maintain a reverse engineering environment on a VM.](https://github.com/mandiant/flare-vm)
---
  - **Malware-Traffic-Analysis.net**  
...
---
  - **Bazaar**  
    An open repository hosting malware samples (with hashes and metadata) to support malware research and analysis.
    [Bazaar](https://bazaar.abuse.ch/browse/)
    Malware repository (Thanks Chief Kincaid!)
---
  - **CAPA**  
...
<!-- Scripting -->
  ...
  ---
  - **LinePEAS**  
    Privilege escalation script for Linux  
    [PEASS-ng/linPEAS at master · peass-ng/PEASS-ng](https://github.com/carlospolop/PEASS-ng/tree/master/linPEAS)
  ---
  - **WinPEAS**  
    Privilege escalation script for Windows  
    [PEASS-ng/winPEAS at master · peass-ng/PEASS-ng](https://github.com/carlospolop/PEASS-ng/tree/master/winPEAS)
  ---
  - **Chisel**  
    Reverse Tunneling  
...
* **CBR-Queries**
  ...
  [Carbon-Black-Response/CB-R_queries.md at master · jteddy/Carbon-Black-Response](https://github.com/jteddy/Carbon-Black-Response/blob/master/CB-R_queries.md)
...
<summary>Windows Artifact Analysis</summary>
  ...
  - **RegRipper 3.0**  
    A registry parsing tool for extracting and reporting Windows Registry data useful for forensic investigations.  
    [GitHub - keydet89/RegRipper3.0: RegRipper3.0](https://github.com/keydet89/RegRipper3.0)
---
  - **KAPE**  
    A triage program that collects and processes forensic artifacts.  
    [KAPE - Kroll](https://www.kroll.com/en/services/cyber-risk/incident-response-litigation-support/kape)
...
---
  - **LAPSDump**  
    Dump LAPS passwords  
    [GitHub - CiscoCXSecurity/creddump7](https://github.com/CiscoCXSecurity/creddump7)
---
  - **PowerView**  
    PowerShell AD recon  
